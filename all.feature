...
Scenario: Buy 1 product in Products page updates the shopping cart and the product status
...
Scenario: Buy 2 products in Products page updates the shopping cart and the product status
    Given I am logged into Products page with "standard_user" user
    When I select "Add To Cart" option for "2" "unselected" random products
    Then I see product option is "Remove" for "selected" products at "Products" page
    And I see "2" badge in shopping cart at "Products" page

Scenario: Remove Not the last product in Products page updates the shopping cart and the product status
    Given I am logged into Products page with "standard_user" user
...
Scenario: Remove the last product in Products page updates the shopping cart and the product status
    Given I am logged into Products page with "standard_user" user
...
Scenario: Buy First cart product at Detail page updates the shopping cart and the product status
...
Scenario: Buy Not the First cart product at Detail page updates the shopping cart and the product status
...
Scenario: Remove not the last cart product at Detail page updates the shopping cart and the product status
...
Scenario: Remove the last product at Detail page updates the shopping cart and the product status
    Given I select "1" "unselected" random products when logged as "standard_user" user
...
Scenario: Reset App State left menu option in Detail page resets Shopping Cart and products status
    Given I select random "unselected" random product "name" when logged as "standard_user" user
    And I select "Menu" option at "Detail" page
    When I select "Reset App State" option at left menu
...
Scenario: Remove Not the Last cart product in Your Cart page updates the shopping cart and the product status
    ...
    And I see "(1|2)" badge in shopping cart at "Your Cart" page

Scenario: Remove the Last cart product in Your Cart page updates the shopping cart and the product status
    Given I proceed to "Your Cart" page with "1" selected random products when logged as "standard_user" user
    When I select "Remove" option for random Cart product
    Then I don't see "any" product at "Your Cart" page
    And I don't see any badge in shopping cart at "Your Cart" page

Scenario: Checkout access is Enabled when product is in shopping cart
    Given I proceed to "Your Cart" page with "1" selected random products when logged as "standard_user" user
    When I select "Checkout" option at "Your Cart" page
    Then I see "Your Information" page

Scenario: Checkout access is Disabled when there is no product in shopping cart
    Given I am logged into Products page with "standard_user" user
    When I select "Shopping Cart" option at "Products" page
...
Scenario: Invalid Continue wehn only one (random) field is filled in Your Information page throws a field missing error
    Given I proceed to "Your Information" page with "1" selected random products when logged as "standard_user" user
...
Scenario: Reset App State left menu option in Your Information page resets cart products in Overview page
    Given I proceed to "Your Information" page with "1" selected random products when logged as "standard_user" user
    And I select "Menu" option at "Your Information" page
    And I select "Reset App State" option at left menu
    And I fill all fields in "Your Information" page
    When I select "Continue" option at "Your Information" page
...
Scenario: Finish purchase in Overview page sends you to Complete page
...
Scenario: Finish the purchase resets the shopping cart
...
Scenario: Left Menu's Reset resets shopping cart in Detail page
    Given I select random "unselected" random product "name" when logged as "standard_user" user
    And I select "Menu" option at "Detail" page
    And I select "Reset App State" option at left menu
    When I select "Shopping Cart" option at "Detail" page
